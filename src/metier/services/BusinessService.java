...
public class BusinessService {
    ...
    public void removeRepairer(User repairer, Shop shop) {
        if (repairer == null || shop == null) return;
        // Remove from shop's repairers list
        shop.getRepairers().remove(repairer);
        // Clear the repairer's shop reference
        repairer.setShop(null);
        // Remove from UserDAO to allow username reuse
        userDAO.removeUser(repairer);
    }
