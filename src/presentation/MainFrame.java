...
public class MainFrame extends JFrame {
    ...
    public static void main(String[] args) {
        // Ensure only one instance is visible at a time
        SwingUtilities.invokeLater(() -> {
            if (instance != null && instance.isDisplayable()) {
                // If an instance already exists and is visible, bring it to front
                instance.toFront();
                instance.requestFocus();
                instance.setState(java.awt.Frame.NORMAL); // Restore if minimized
            } else {
                // Create new instance
